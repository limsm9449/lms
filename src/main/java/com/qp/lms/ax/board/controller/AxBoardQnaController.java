...
public class AxBoardQnaController {
    ...
    public @ResponseBody HashMap<String,Object> axBoardQnaOne(@RequestBody HashMap<String, Object> paramMap, HttpServletRequest request, HttpServletResponse response) throws Exception {
    	HashMap<String, Object> hm = new HashMap<String, Object>();
