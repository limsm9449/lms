...
public class CostNotPayVO extends CommonVO {
	...
	private String notPaymentCost;
	private String registerCnt;
	private String costNotPayCnt;
	...
	public String getNotPaymentCost() {
		return notPaymentCost;
	}
	public void setNotPaymentCost(String notPaymentCost) {
		this.notPaymentCost = notPaymentCost;
	}
	...
	public String getCostNotPayCnt() {
		return costNotPayCnt;
	}
	public void setCostNotPayCnt(String costNotPayCnt) {
		this.costNotPayCnt = costNotPayCnt;
	}
	public static long getSerialversionuid() {
		return serialVersionUID;
	}
