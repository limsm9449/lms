...
function lfn_btn(pKind, pParam) {
	if ( pKind == "list" ) {
		...
		$.ajax({
			type :"POST",
			url : context + "/user/studyroomQnaAnswerUpd.do",
			dataType :"json",
			data : $("#frm").serialize(),
...
<input id="answerSeq" name="answerSeq" type="hidden" value="${set.condiVO.answerSeq}">
		                ...
		                <table>
		                  <caption>답변 폼</caption>
		                    ...
		                    <tr class="last_line">
		                      ...
		                      <td>
		                        <textarea id="contents" name="contents">${set.boardAnswer.contents}</textarea>
		                      </td>
		                    </tr>
		                  </tbody>  
		                </table>
