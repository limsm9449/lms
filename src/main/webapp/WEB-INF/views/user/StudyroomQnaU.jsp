...
function lfn_btn(pKind, pParam) {
	if ( pKind == "list" ) {
		...
		$.ajax({
			type :"POST",
			url : context + "/user/studyroomQnaUpd.do",
			dataType :"json",
			data : $("#frm").serialize(),
...
<input id="seq" name="seq" type="hidden" value="${set.boardQna.seq}">
		                ...
		                <table>
		                  <caption>질문하기 폼</caption>
		                    ...
		                    <tr>
		                      ...
		                      <td><input type="text" name="title" id="title" class="full" value="${set.boardQna.title}"/></td>
		                    </tr>
		                    <tr class="last_line">
		                      <th><label for="contents">내용</label></th>
		                      <td>
		                        <textarea id="contents" name="contents">${set.boardQna.contents}</textarea>
		                      </td>
		                    </tr>
		                  </tbody>  
		                </table>
