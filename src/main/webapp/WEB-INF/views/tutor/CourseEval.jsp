...
function lfn_btn(pKind, pParam) {
	if ( pKind == "courseEvalV" ) {
		gfn_goPage("/tutor/courseEvalV","courseId=" + pParam.courseId + "&userId=" + pParam.userId);
	} else if ( pKind == "list") {
		gfn_goPage("/tutor/myCourse",top.gCondition.myCourse.param);
		...
		if ( confirm("완료처리 하시겠습니까?") == true ) {
			...
			$.ajax({
				type :"POST",
				url : context +"/tutor/evalCompleteUpd.do",
				dataType :"json",
				data : $("#frm").serialize(),
