...
function lfn_btn(pKind, pParam) {
	if ( pKind =="save" ) {
		...
		$.ajax({
			type :"POST",
			url : context + preUrl + "boardDiscussionIns.do",
			dataType :"json",
			data : $("#frm").serialize(),
...
<form id="frm" name="frm" action="" method="post">
	...
	<input id="ref" name="ref" value="${set.condiVO.ref}" type="hidden"/>
	<input id="ord" name="ord" value="${set.condiVO.ord}" type="hidden"/>
	<input id="step" name="step" value="${set.condiVO.step}" type="hidden"/>


<div id="popup_wrap">
  <div class="pop_header">
    <h3 class="title">토론 게시판 - 글쓰기</h3>
