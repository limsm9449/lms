...
var pageObj = {
	...
	axPointDetailList :		{	page : "/ax/account/axPointDetailList"	},	
...
<c:if test="${auth eq 'ADMIN'}">         		
	          		...
	          		<li><a href="#" class="mainMenu linker" onclick="gfn_openMenu('axPointList'); gfn_menu(this)"><span>포인트 관리</span></a></li>
