	    	...
	    	<div id="menu">
        		<ul class="snb">
	          		<li><a href="#" class="mainMenu linker" onclick="gfn_menu(this)"><span>강좌관리</span></a>
			            <ul class="subMenuUl">
			              	<li><a href="#" id="defaultMenu" name="defaultMenu" class="subMenu linker" onclick="f_menuContent('/teacher/myCourse'); gfn_subMenu(this);"><span>담당 강좌 리스트</span></a></li>
			         	</ul>
			      	</li>
	          		<li><a href="#" class="mainMenu linker" onclick="gfn_menu(this)"><span>비용관리</span></a>
			            <ul class="subMenuUl">
			              	<li><a href="#" class="subMenu linker" onclick="f_menuContent('/cost/teacherCostPayList'); gfn_subMenu(this);"><span>이익금 지급 관리</span></a></li>
			         	</ul>
			      	</li>
        		</ul>
      		</div>
