        ...
        <div class='contents_wrap_box' >
            ...
            <div class='util_wrap'>
                ...
                <div class='util_step_box clear_fix'>
                    ...
                    <div class='active'>
                        <span><img src='/resources/homepageCch/img/etc/ic_step2_active.png' alt=''></span>
                        <p>가입여부<span></span>확인</p>
                    </div>
                    <div class='arrow'><img src='/resources/homepageCch/img/etc/arr_right.png' alt=''></div>
                    <div>
                        <span><img src='/resources/homepageCch/img/etc/ic_step3.png' alt=''></span>
                ...
                <div class='signup_title_box'>
                    ...
                    <p>
                        주민등록번호 입력 없이 휴대폰 인증으로 회원가입이 가능합니다.
                    </p>
                </div>
...
<c:forEach var="i" begin="1" end="31" step="1" varStatus ="status">
	...
	<c:if test="${i >= 10}">
                    ...
                    <div class='certification_note'>
                        <p>
                            주민등록 번호 입력 없이 휴대폰 인증으로 회원가입이 가능합니다.<span></span><strong>이름, 생년월일, 성별은 가입 후에 변경이 불가능합니다. 추후 본인확인을 위해 정확하게 가입 부탁드립니다.</strong><span></span>회원가입 후 고용보험과정을 수강 신청 시 노동부에 고용보험신고를 위해 주민등록 번호를 수집하고 있습니다.<span></span>가급적 신분증과 동일한 정보를 입력하시면 향후 고용보험 과정 수강 시 본인 확인이 용이합니다.
                        </p>
                    </div>
                </div>
