  ...
  <div id="container" class="site">
		...
		<div id="side" class="site">
			...
			<ul class="snb">
				...
				<li><a href="javascript:" onclick="page.goPage('/guest/termsconditions');" class="here">서비스이용약관</a></li>
		...
		<div id="contents" class="site">
			<!-- location -->
			<div id="location"><a href="/" class="home">HOME</a><span>&gt;</span>회원가입<span>&gt;</span>서비스이용약관</div>
			<!-- title -->
			<h3 class="tit_big">서비스이용약관</h3>
		      <div class="artcle">
		        <div class="privacy_box">
		          <div class="text_box" style="height: 2500px;">
