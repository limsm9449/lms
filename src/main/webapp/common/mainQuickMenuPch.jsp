            ...
            <div class='quick_menu_wrap'>
                ...
                <ul>
                    ...
                    <a href='#' onclick="page.goPage('/main/courseList', '');">
                    	<li class='quick_menu_list' id="q_menu2"><c:if test="${!empty cart}"><img src="/resources/homepagePch/img/main/quick/q_menu2_circle.png" alt=' ' id="q_menu2_circle"><span class="q_menu2_num">${cart.size()}</span></c:if></li>
                    </a>
