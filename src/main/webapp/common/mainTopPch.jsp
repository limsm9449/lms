...
<c:if test="${empty session}">
       				...
       				<a href="/login.do" onclick='login()'>로그인-P</a>
</c:if>      		
<c:if test="${!empty session}">      		
                    <a href="javascript:" onclick="gfn_ajax.logout()" class='last_right'>로그아웃-P</a>
            ...
            <div class='mobile_dropwdown_wrap'>
                <div class='mobile_bg_box'>
                    ...
                    <div class='mobile_menu service'>
                        ...
                        <ul>
                            <li class='first_depth'><a href='/resources/homepagePch/html/support/support.html'>큐러닝</a></li>
