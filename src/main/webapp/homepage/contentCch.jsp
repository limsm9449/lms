...
<head>
    ...
    <script src='/resources/homepageCch/js/jquery.bxslider.js'></script>

    <link href='https://fonts.googleapis.com/css?family=Nanum+Gothic' rel='stylesheet'>
    <link href="https://fonts.googleapis.com/css?family=Noto+Sans" rel="stylesheet">

    <link rel='stylesheet' type='text/css' href='/resources/homepageCch/css/initialization.css'>
    <link rel='stylesheet' type='text/css' href='/resources/homepageCch/css/main.css?timestamp=<%=timestamp%>'>
    <link rel='stylesheet' href='/resources/homepageCch/css/IE_style.css'>    
</head>
	...
	<c:choose>
 		...
 		<c:when test = "${row.FRAME_KIND eq 'THUMBNAIL_SLIDE'}">
            ...
            <div class="star_slide" style="margin-bottom:${row.BOTTOM_HEIGHT}px">
            	<img id="star_back" src="/resources/homepageCch/img/main/star_b.png" alt="" width="74" onclick="back('thumbnailSlide_${row.SEQ}')">
                ...
                <img id="star_next" src="/resources/homepageCch/img/main/star_n.png" alt="" width="74" onclick="next('thumbnailSlide_${row.SEQ}')">
           </div>
        </c:when>
 		<c:when test = "${row.FRAME_KIND eq 'MP4'}">
 			<div class='recommend_wrap lectures_wrap' style="margin-bottom:${row.BOTTOM_HEIGHT}px">
            ...
            <div class="m1">
                <div id="movie1">
                	<div class="v1_close" id="vclose" onClick="fn_close()">
                		<img src ="/resources/homepageCch/img/main/ic_menu_close.png" alt="">
                	</div>
	...
	<c:forEach var="row" items="${set.postScriptList}" varStatus="idx">
                        <li class='clear_fix'>
                            ...
                            <div class='p_result_review con'>
                                <div class='clear_fix'>
                                	<img src="/resources/homepageCch/img/main/u_line.png" alt='' class="u_line">
	                                <span><img src='/resources/homepageCch/img/course/${row.eval1}.png' alt=''></span>
	                                <span><img src='/resources/homepageCch/img/course/${row.eval2}.png' alt=''></span>
	                                <span><img src='/resources/homepageCch/img/course/${row.eval3}.png' alt=''></span>
	                                <span><img src='/resources/homepageCch/img/course/${row.eval4}.png' alt=''></span> 
	                                <span><img src='/resources/homepageCch/img/course/${row.eval5}.png' alt=''></span>
