...
<head>
    ...
    <link rel='stylesheet' href='/resources/homepageCch/css/course/register_course.css'>
</head>
                ...
                <div class='register_course_contents clear_fix'>
                    <div class='register_course_image'>
                        ...
                        <div class='register_course_review clear_fix'>
                            <span><img src='/resources/homepageCch/img/course/${set.courseData.grade1}.png' alt=' '></span>
                            <span><img src='/resources/homepageCch/img/course/${set.courseData.grade2}.png' alt=' '></span>
                            <span><img src='/resources/homepageCch/img/course/${set.courseData.grade3}.png' alt=' '></span>
                            <span><img src='/resources/homepageCch/img/course/${set.courseData.grade4}.png' alt=' '></span>
                            <span><img src='/resources/homepageCch/img/course/${set.courseData.grade5}.png' alt=' '></span>
                            <p>
