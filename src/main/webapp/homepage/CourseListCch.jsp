...
<head>
    ...
    <link rel='stylesheet' href='/resources/homepageCch/css/course/process.css'>
</head>
			...
			<c:if test="${row.offlineYn eq 'Y'}">     	                                    
	                        ...
	                        <div class='process_result_review con'>
	                            <div class='clear_fix' onclick="Popup.showPostscriptList('${row.courseId}')">
	                                <span><img src='/resources/homepageCch/img/course/${row.grade1}.png' alt=''></span>
	                                <span><img src='/resources/homepageCch/img/course/${row.grade2}.png' alt=''></span>
	                                <span><img src='/resources/homepageCch/img/course/${row.grade3}.png' alt=''></span>
	                                <span><img src='/resources/homepageCch/img/course/${row.grade4}.png' alt=''></span>
	                                <span><img src='/resources/homepageCch/img/course/${row.grade5}.png' alt=''></span>
	                            </div>
	                            <p>
