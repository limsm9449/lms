...
function lfn_btn(pKind, pParam) {
	if ( pKind =="update" ) {
		gfn_goPage(preUrl + "boardFreeU",$("#frm").serialize()); 
		...
		gfn_goPage(preUrl + "boardFreeList",top.gCondition.boardFree.param); 
	}
}
...
<c:if test="${set.condiVO.isEdit eq 'Y' && set.userId eq set.data.userId}">
		  		...
		  		<iframe id="replyFrame" name="replyFrame" class="" scrolling="auto" frameborder="0" style="width:100%;"></iframe>
