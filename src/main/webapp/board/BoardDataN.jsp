...
$(document).ready(function() {
	$("#attachFrame").attr("src","/board/attachI.do?" + "pSeq=${set.condiVO.seq}&kind=B_DATA&mode=TEMP");
...
function lfn_btn(pKind, pParam) {
	if ( pKind =="save" ) {
		...
		$.ajax({
			type :"POST",
			url : context + preUrl + "boardDataIns.do",
			dataType :"json",
			data : $("#frm").serialize(),
		...
		gfn_goPage(preUrl + "boardDataList",top.gCondition.boardData.param); 
	}
}
				...
				<table class="input">
					...
					<tbody>
						...
						<tr>
							<th>첨부파일</th>
							<td class="textbox no_line">
								<iframe id="attachFrame" name="attachFrame" style="width:100%;height:100%"></iframe>
							</td>
						</tr>
					</tbody>
				</table>
