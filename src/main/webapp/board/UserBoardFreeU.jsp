...
function lfn_btn(pKind, pParam) {
	if ( pKind =="save" ) {
		...
		$.ajax({
			type :"POST",
			url : context + preUrl + "BoardFreeUpd.do",
			dataType :"json",
			data : $("#frm").serialize(),
			success : function(json){
				if ( json.rtnMode == "UPDATE_OK") {
					page.goPage('/board/userBoardQnaList', decodeURIComponent('${set.condiVO.prevParams}'));
				}
			},
			error : function(e) {
        ...
        <div class='contents_wrap process'>
            <div class='contents_wrap_box popup'>
                ...
                <div class='detail_btn_area'>
                    <a href="#" onclick="page.goPage('/board/userBoardQnaList', decodeURIComponent('${set.condiVO.prevParams}'));">취소</a>
