...
<head>
    ...
    <link rel='stylesheet' href='/resources/homepageCch/css/myclass/classroom.css'>
</head>

<script src='/resources/homepageCch/js/main.js?timestamp=<%=timestamp%>'></script>
<script type="text/javascript" src="/resources/js/qpApi.js?timestamp=<%=timestamp%>"></script>

<script>

resources = '/resources/homepageCch/';
...
<frameset rows='*'>
         ...
         <div class="cl_top">
         	<div class="mobile_topbtn" onclick="mobile_show();">
            	<img src="/resources/homepageCch/img/myclass/top_btn.png">
            </div>
            <div class="top_title">
         ...
         <div class="cl_close" id="index_close" onClick="mobile_close();">
         	<img src="/resources/homepageCch/img/myclass/close.png">
         </div>
...
<c:forEach var="row" items="${set.resourceList}" varStatus="idx">
	<c:if test="${row.myWeek eq 'Y'}">                   
        ...
        <div class="videohtml">
        <style>
        #eduContent{margin: 0 auto; max-width: ${set.courseInfo.hPx}px; max-height: ${set.courseInfo.vPx}px;  width:calc((100vh - 56px) * ${set.courseInfo.hPx} / ${set.courseInfo.vPx}); height: calc(100vh - 56px); }
   		@media only screen and (orientation: portrait) {
 	 		#eduContent{width:100%; height:calc(${set.courseInfo.vPx}vw * 0.1 ); }
		}
        </style>
        	<div class="innerhtml" >
            ...
            <div class="video_nav">
                <div class="nav_btn_group">
                    <img src="/resources/homepageCch/img/myclass/b_btn.png" style="cursor:pointer" class="b_btn" onclick="QP_API.goPrevPage();">
                    ...
                    <img src="/resources/homepageCch/img/myclass/n_btn.png" style="cursor:pointer" class="n_btn" onclick="QP_API.goNextPage();">
