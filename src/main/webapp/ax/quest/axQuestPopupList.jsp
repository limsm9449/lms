    ...
    $('[data-grid-control]').click(function () {
        switch (this.getAttribute("data-grid-control")) {
            ...
            case "add":
            	...
            	grid.addRow({NEW_FLAG : "Y", QG_ID : params.QG_ID, SEQ : maxSeq + 1, TYPE : "G", QUESTION : "질문을 입력하세요.", USE_YN : "Y"}, "last", {focus: "END"});
                break;
            case "delete":
...
function fn_params() {
	params.QG_ID = gfn_getUrlParams("QG_ID");	
}
...
function fn_search() {
	...
	gfn_callAjax("/quest/axQuestList.do", params, fn_callbackAjax, "search");
}
	...
	var fieldParams = {
   	...
   	if ( gfn_validationCheck(grid, fieldParams) ) {
       	...
       	confirmDialog.confirm(
           	...
           	function(){
             	if ( this.key == "ok" ) {
             		gfn_callAjax("/quest/axQuestSave.do", gfn_getSaveData(grid), fn_callbackAjax, "save");
               	} else {
               		mask.close();
               	}
           	}
