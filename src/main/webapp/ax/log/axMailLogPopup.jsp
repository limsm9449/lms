...
function fn_search() { 
	...
	gfn_callAjax("/log/axMailLogOne.do", params, fn_callbackAjax, "search");
}
...
<form class="form-horizontal">
  	<div class="form-group">
    	...
    	<div class="col-sm-10">
      		<input type="text" class="form-control" id="TITLE" placeholder="제목" readonly>
    	</div>
  	</div>
  	<div class="form-group">
