    ...
    $('[data-grid-control]').click(function () {
        switch (this.getAttribute("data-grid-control")) {
		    ...
		    case "addReply":
            	...
            	var urlParams = "page=/ax/board/axBoardDiscussionPopup";
           		urlParams += "&MODE=REPLY_INSERT&COURSE_ID=" + params.COURSE_ID + "&SEQ=" + row[0].SEQ;
...
function fn_gridEvent(event, obj) {
	if ( event == "Click" ) {
		obj.self.select(obj.dindex);
   		...
   		f_popup('/common/axOpenPage', {displayName:'boardDiscussionPopup',option:'width=900,height=500', urlParams:urlParams});
