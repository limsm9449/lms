...
$(document.body).ready(function () {
    ...
    gfn_callAjax("/common/axDd.do", { DD_KIND : "CategoryLevel1,Tutor,CompanyKind,Company,Company1,Company2,Year" }, fn_callbackAjax, "dd", { async : false });
...
<div class="form-inline">
  	...
  	<div class="form-group">
		...
		<select class="form-control" id="CB_CLOSE">
			<option value="">전체</option>
