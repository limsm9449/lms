    ...
    $('[data-grid-control]').click(function () {
        switch (this.getAttribute("data-grid-control")) {
		    ...
		    case "add":
           		...
           		urlParams += "&MODE=INSERT&SEQ=&COURSE_ID=" + params.COURSE_ID + "&KIND=B_REPORT";
           		
           		f_popup('/common/axOpenPage', {displayName:'boarddReportPopup',option:'width=900,height=700', urlParams:urlParams});
...
function fn_gridEvent(event, obj) {
	if ( event == "Click" ) {
		...
		if ( obj.item["MY_BOARD_YN"] == "Y" ) {
   		...
   		var urlParams = "page=/ax/board/axBoardReportPopup";
   		urlParams += "&MODE=" + mode + "&SEQ=" + obj.item["SEQ"] + "&COURSE_ID=" + params.COURSE_ID + "&KIND=B_REPORT";
