            ...
            <div class='contents_wrap_box'>
                ...
                <div class='basket_step_box'>
                    <ul>
                        ...
                        <li class='basket_step_list clear_fix'>
                            <span><img src='/resources/homepageCch/img/classroom/basket_step2_inactive.png' alt=' '></span>
                        ...
                        <li class='basket_step_list clear_fix on'>
                            <span><img src='/resources/homepageCch/img/classroom/basket_step3_active.png' alt=' '></span>
                ...
                <div class='basket_payment_completed'>
                    <div>
                        ...
                        <button onclick="page.goPage('/normalUser/attendCourseList');">나의 강의실 바로가기</button>
                    </div>
                </div>
            </div>
        </div>
