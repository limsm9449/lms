...
<%@ include file="../../homepage/cfg/site_conf_inc.jsp"%>
...
<form id="order_info" name="order_info" method="post" action="/siteManager/ppAxHub.do" onsubmit="return false;">
	...
	<input id="selIds" name="selIds" type="hidden" value="${userIds}"/>
		      ...
		      <div class="artcle">
		        <div class="payment_box">
		          ...
		          <table class="cart_list">
		          	<caption>결제 리스트</caption>
		  					...
		  					<tbody>
		  						<tr class="head">
		  							<td></td>
		  							<td class="center">수강신청자</td>
		  							<td class="center">금액</td>
		  						</tr>
			              <tr>
			              	<td class="center"></td>
			                <td class="title">
								인원 : ${applicationCnt} 명<br>
								${userNames}
			               	</td>
			                <td class="center"><fmt:formatNumber value="${paymentCost}" type="number"/> 원</td>
			              </tr>
		            </tbody>
		          </table>
		          <div id="payment_total">
		          	<p>
			          	주문금액 :
			          	<span class="blue big"><fmt:formatNumber value="${paymentCost}" type="number"/></span>
			          	원
			          	...
			          	<span class="blue big" id="paymentCost1"><fmt:formatNumber value="${paymentCost}" type="number"/></span>
			          	원
			          	<input id="totalCost" name="totalCost" type="hidden" readonly value="${paymentCost}"/>
			          	<input id="remainPoint" name="remainPoint" type="hidden" value="${point}"/>
			          	<input id="paymentCost" name="paymentCost" type="hidden" value="${paymentCost}"/>
			          	<input type="hidden" name="good_mny" id="good_mny" class="w100" readonly value="${paymentCost}" maxlength="9"/>
		          	</p>
		          </div>
		          ...
		          <table class="mem_form">
		            <caption>결제자 정보</caption>
	                    ...
	                    <tr>
	                        <th>주문자명</th>
	                        <td>${user.USER_NAME}<input type="hidden" name="buyr_name" class="w100" readonly value="${user.USER_NAME}"/></td>
	                    </tr>
	                    <!-- 주문자 E-mail(buyr_mail) -->
	                    <tr>
	                        <th>E-mail</th>
	                        <td>${user.EMAIL}<input type="hidden" name="buyr_mail" class="w200" readonly value="${user.EMAIL}" maxlength="30" /></td>
	                    </tr>
	                    <!-- 주문자 연락처1(buyr_tel1) -->
	                    <tr style="display:none">
	                        <th>전화번호</th>
	                        <td><input type="text" name="buyr_tel1" class="w100" readonly value="${user.MOBILE}"/></td>
	                    </tr>
	                    <!-- 휴대폰번호(buyr_tel2) -->
	                    <tr>
	                        <th>휴대폰번호</th>
	                        <td>${user.MOBILE}<input type="hidden" name="buyr_tel2" class="w100" readonly value="${user.MOBILE}"/></td>
	                    </tr>		
		            </tbody>  
		          </table>
		          <br />
		            ...
		            <caption>결제 선택</caption>
                      ...
                      <tr id="bankTr" style="display:none">
                        <th><label for="paymentBank" class="must">은행</label></th>
	                        <td>
								<select id="paymentBank" name="paymentBank" style="width:270px">
									<option value="" selected></option>
									<c:forEach var="row" items="${bankList}" varStatus="idx">
		              ...
		              <tr>
		                ...
		                <td><p class="total">최종결제 금액 : <span class="blue big" id="paymentCost2"><fmt:formatNumber value="${paymentCost}" type="number"/></span>원</p></td>
		              </tr>
		            </tbody>
		          </table>
