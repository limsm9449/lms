...
<html xmlns="http://www.w3.org/1999/xhtml" >
    ...
    <form name="pay_info" method="post" action="/pg/result.do">
		...
		<input id="totalCost" name="totalCost" type="hidden" value="<%=totalCost%>"/>
		<input id="paymentPoint" name="paymentPoint" type="hidden" value="<%=paymentPoint%>"/>
		<input id="paymentCost" name="paymentCost" type="hidden" value="<%=paymentCost%>"/>
		<input id="paymentKind" name="paymentKind" type="hidden" value="<%=paymentKind%>"/>
		<input id="paymentBank" name="paymentBank" type="hidden" value="<%=paymentBank%>"/>
		<input id="approvalId" name="approvalId" type="hidden" value="<%=paymentBank%>"/>
    </form>
	</body>
</html>