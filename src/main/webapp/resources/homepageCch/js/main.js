...
function m_menu_open(btn, page) {
    var url_up = '';
    var url_down = '';

    switch (page) {
        case 'main':
            url_up = 'url("'+resources+'img/main/menu_arr_up.png") #fff 98% 64% no-repeat';
            url_down = 'url("'+resources+'img/main/menu_arr_down.png") #fff 98% 64% no-repeat';
            break;
        case 'others':
            url_up = 'url("'+resources+'img/main/menu_arr_up.png") #fff 98% 64% no-repeat';
            url_down = 'url("'+resources+'img/main/menu_arr_down.png") #fff 98% 64% no-repeat';
...
function p_v1_show(){
	p_movie1.style.display= "block";
	p_vclose.style.display = "block";
	p_video1.play();
}
function p_v_close(){
	p_movie1.style.display= "none";
	p_vclose.style.display = "none";
