...
function guide_change(focused, elem){
    ...
    var pc1_box = document.getElementsByClassName('register_method_pc1')[0];
    var pc2_box = document.getElementsByClassName('register_method_pc2')[0];
	var pc3_box = document.getElementsByClassName('register_method_pc3')[0];
	var pc4_box = document.getElementsByClassName('register_method_pc4')[0];
	var pc5_box = document.getElementsByClassName('register_method_pc5')[0];
    ...
    if(focused === 'pc1'){
        pc1_box.style.display = 'block';
        pc2_box.style.display = 'none';
		pc3_box.style.display = 'none';
		pc4_box.style.display = 'none';
		pc5_box.style.display = 'none';
    }else if(focused === 'pc2'){
        pc1_box.style.display = 'none';
        pc2_box.style.display = 'block';
		pc3_box.style.display = 'none';
		pc4_box.style.display = 'none';
		pc5_box.style.display = 'none';
    }else if(focused === 'pc3'){
